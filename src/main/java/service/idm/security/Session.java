...
public class Session {
    public static final long SESSION_TIMEOUT = IDMService.getTimeout(); // 10-minute timeout
    public static final long TOKEN_EXPR = IDMService.getExpiration(); // 30-minute expiration
