...
import service.idm.configs.Configs;
import service.idm.configs.ConfigsModel;
...
public class IDMService {
    ...
    private void initHTTPServer() {
        ...
        try {
            ...
            ResourceConfig rc = new ResourceConfig().packages("service.idm.resources");
    ...
    private void setUpSession(){
        ServiceLogger.LOGGER.config("Setting Session Time...");
        timeout = configs.getTimeout();
        expiration = configs.getExpiration();
    }
